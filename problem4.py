...
import json
# Note: json is a built-in Python module for working with JSON (JavaScript’) data
...
def save_contacts_to_file(contacts, filename="contacts.json"):
    ...
    """
    result=save_to_json(contacts,filename)
    return result
...
def append_contact_to_file(contact, filename="contacts.json"):
    ...
    result = save_contacts_to_file(contacts, filename)
    return result
